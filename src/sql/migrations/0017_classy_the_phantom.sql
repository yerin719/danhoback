...
CREATE TYPE "public"."flavor_category" AS ENUM('grain', 'chocolate', 'strawberry', 'banana', 'milk', 'coffee', 'original', 'black_sesame', 'matcha', 'milktea', 'greentea', 'anilla', 'other');--> statement-breakpoint
